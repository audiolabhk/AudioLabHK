    ...
    <section className="py-5 bg-gray-100">
      <div className="container max-w-6xl mx-auto">
        ...
        <p className="mt-2 text-lg text-center text-gray-600">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum ullam inventore neque reprehenderit perspiciatis praesentium accusantium officia asperiores debitis atque facilis in dolor, eius aliquam voluptatum voluptas repudiandae similique. Ratione?
        </p>
